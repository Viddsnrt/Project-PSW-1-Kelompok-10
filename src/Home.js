    ...
    <div className="home-container">
      ...
      <div className="slider-container">
        <div className="slide-item">
          <img src="path_to_your_image_1.jpg" alt="Materi Kimia 1" className="slider-image" />
          <div className="slider-caption">Materi Kimia Dasar</div>
        </div>
        <div className="slide-item">
          <img src="path_to_your_image_2.jpg" alt="Materi Kimia 2" className="slider-image" />
          <div className="slider-caption">Reaksi Kimia</div>
        </div>
        <div className="slide-item">
          <img src="path_to_your_image_3.jpg" alt="Materi Kimia 3" className="slider-image" />
