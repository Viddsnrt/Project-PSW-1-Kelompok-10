...
function SifatKoligatif() {
  ...
  const questions = [
    ...
    {
      question: "Sifat koligatif yang dipengaruhi oleh jumlah partikel terlarut dalam larutan adalah..",
      options: ["Penurunan titik beku", "Peningkatan titik didih", "Tekanan uap", "Kelarutan", "Densitas"],
      correctAnswer: "Penurunan titik beku",
      explanation: "Penurunan titik beku adalah salah satu sifat koligatif yang bergantung pada jumlah partikel terlarut, bukan jenisnya.",
    },
    {
      question: "Salah satu contoh aplikasi dari penurunan titik beku pada larutan adalah..",
      options: ["Pembuatan es krim", "Pencairan salju pada jalan", "Penyulingan air laut", "Pembuatan soda", "Pembuatan kue"],
      correctAnswer: "Pencairan salju pada jalan",
      explanation: "Penurunan titik beku digunakan untuk mencairkan salju di jalan dengan menambahkan garam.",
    },
    {
      question: "Sifat koligatif yang dapat digunakan untuk mengukur massa molar suatu zat terlarut adalah..",
      options: ["Penurunan titik beku", "Peningkatan titik didih", "Tekanan osmotik", "Penyusutan volume", "Semua benar"],
      correctAnswer: "Semua benar",
      explanation: "Semua sifat koligatif, seperti penurunan titik beku, peningkatan titik didih, dan tekanan osmotik, dapat digunakan untuk menentukan massa molar zat terlarut.",
    },
    {
      question: "Tekanan osmotik dalam larutan dipengaruhi oleh..",
      options: ["Suhu", "Jenis pelarut", "Jumlah partikel terlarut", "Kecepatan partikel", "Panjang molekul terlarut"],
      correctAnswer: "Jumlah partikel terlarut",
      explanation: "Tekanan osmotik bergantung pada jumlah partikel terlarut dalam larutan, bukan jenisnya.",
    },
